...
import {getProductByKeyword} from '../../hooks/search/searchProduct';
...
const SearchResultScreen: React.FC = () => {
  ...
  const product = getProductByKeyword(keyword);
    ...
    <SafeAreaView className="bg-white px-2 p-3 flex-1 h-screen">
      <ScrollView>
        ...
        <View className={`h-screen`}>
          <SortOption label={tags} data={product.items} />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
